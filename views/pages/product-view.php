        ...
        <div class="row">
                    ...
                    <div class="slider-fouc pd-wrap">
                        <div id="pd-o-initiate">
                            <div class="pd-o-img-wrap" data-src="<?php echo $product['product_image']; ?>">
                                <img class="u-img-fluid" src="/public/images/products/<?php echo $product['product_image']; ?>" alt="Product Image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7">
                <div class="pd-detail">
                    ...
                    <div>
                        <span class="pd-detail__name"><?php echo htmlspecialchars($product['product_name']); ?></span>
                    </div>
                    <div>
                        <div class="pd-detail__inline">
                            <span class="pd-detail__price">$<?php echo number_format($product['product_price'], 2); ?></span>
                        </div>
                    </div>
                    <div class="u-s-m-b-15">
                        <span class="pd-detail__preview-desc"><?php echo htmlspecialchars($product['product_description']); ?></span>
                    </div>
                    <div class="u-s-m-b-15">
                                <div class="input-counter">
                                    <span class="input-counter__minus fas fa-minus"></span>
                                    <input class="input-counter__text" type="text" value="1" data-min="1" data-max="<?php echo $product['product_quantity']; ?>">
                                    <span class="input-counter__plus fas fa-plus"></span>
                                </div>
                            </div>
                            <div class="u-s-m-b-15">
                            <a href="/cart/<?= $product['product_id'] ?>"> <button class="btn btn--e-brand-b-2" type="submit">Add to Cart</button></a>
                            </div>
