...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = 'caca564940f992';
        $this->mail->Password = '827e15d2f72827';
    }
...
$url = 'http://localhost/vanilla-php-no-framework-forgotten-pwd-main/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
